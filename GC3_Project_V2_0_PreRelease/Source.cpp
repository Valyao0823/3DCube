...
/*
GLubyte* ConsoleApplication16(char* file, float* width, float* height, int* max);
GLubyte *image;*/
...
fd = fopen(file, "r");
if(fd == NULL) cout << "file not found" << endl ;
...
int main(int argc, char **argv)
{
	...
	//image = ConsoleApplication16("snail_a.ppm", &WIDTH, &HEIGHT, &k);
	glutSetWindow(SECOND_BACK_WINDOW);
	glutDisplayFunc(voidWindow);
